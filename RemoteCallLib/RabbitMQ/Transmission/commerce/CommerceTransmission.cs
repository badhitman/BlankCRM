...
/// </summary>
public partial class CommerceTransmission(IMQClientRPC rabbitClient) : ICommerceTransmission
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public async Task<TResponseModel<int>> OrganizationUpdateOrCreateAsync(TAuthRequestStandardModel<OrganizationModelDB> org, CancellationToken token = default)
    ...
    /// <inheritdoc/>
    public async Task<DocumentNewVersionResponseModel> RowForOrderUpdateOrCreateAsync(TAuthRequestStandardModel<RowOfOrderDocumentModelDB> row, CancellationToken token = default)
        => await rabbitClient.MqRemoteCallAsync<DocumentNewVersionResponseModel>(GlobalStaticConstantsTransmission.TransmissionQueues.RowForOrderUpdateOrCreateCommerceReceive, row, token: token) ?? new();
    ...
    /// <inheritdoc/>
    public async Task<DocumentNewVersionResponseModel> OrderUpdateOrCreateAsync(TAuthRequestStandardModel<OrderDocumentModelDB> order, CancellationToken token = default)
        => await rabbitClient.MqRemoteCallAsync<DocumentNewVersionResponseModel>(GlobalStaticConstantsTransmission.TransmissionQueues.OrderUpdateOrCreateCommerceReceive, order, token: token) ?? new();
    ...
    public async Task<ResponseBaseModel> FileForGoodUpdateAsync(TAuthRequestStandardModel<FileGoodsConfigModelDB> req, CancellationToken token = default)
        => await rabbitClient.MqRemoteCallAsync<ResponseBaseModel>(GlobalStaticConstantsTransmission.TransmissionQueues.FileForGoodsUpdateCommerceReceive, req, token: token) ?? new();
    ...
    public async Task<ResponseBaseModel> MoveFileForGoodsAsync(TAuthRequestStandardModel<MoveMetaObjectModel> req, CancellationToken token = default)
        => await rabbitClient.MqRemoteCallAsync<ResponseBaseModel>(GlobalStaticConstantsTransmission.TransmissionQueues.FileForGoodsMoveCommerceReceive, req, token: token) ?? new();
}