...
public class RubricsListReceive(IRubricsService hdRepo)
    : IResponseReceive<RubricsListRequestStandardModel?, List<RubricNestedModel>?>
{
    /// <inheritdoc/>
    ...
    /// </summary>
    public async Task<List<RubricNestedModel>?> ResponseHandleActionAsync(RubricsListRequestStandardModel? req, CancellationToken token = default)
    {
