...
/// <summary>
/// DeleteUserJoinDialogWebChat
/// </summary>
public class DeleteUserJoinDialogWebChatReceive(IWebChatService webChatRepo)
    : IResponseReceive<TAuthRequestStandardModel<int>?, ResponseBaseModel?>
{
    /// <inheritdoc/>
    public static string QueueName => GlobalStaticConstantsTransmission.TransmissionQueues.DeleteUserJoinDialogWebChatReceive;
    ...
    public async Task<ResponseBaseModel?> ResponseHandleActionAsync(TAuthRequestStandardModel<int>? req, CancellationToken token = default)
    {
        ...
        return await webChatRepo.DeleteUserJoinDialogWebChatAsync(req, token);
    }
}
