...
public static class RegisterMqListenerExtension
{
    ...
    public static IServiceCollection ConstructorRegisterMqListeners(this IServiceCollection services)
    {
        return services
            ...
            .RegisterMqListener<DeleteSessionDocumentConstructorReceive, int, ResponseBaseModel>()
            .RegisterMqListener<ClearValuesForFieldNameConstructorReceive, FormFieldOfSessionModel, ResponseBaseModel>()
            .RegisterMqListener<FindSessionsDocumentsByFormFieldNameConstructorReceive, FormFieldModel, TResponseModel<EntryDictModel[]>>()
            ...
            .RegisterMqListener<DeleteTabDocumentSchemeJoinFormConstructorReceive, TAuthRequestStandardModel<int>, ResponseBaseModel>()
            ...
            .RegisterMqListener<DeleteTabOfDocumentSchemeConstructorReceive, TAuthRequestStandardModel<int>, ResponseBaseModel>()
            ...
            .RegisterMqListener<DeleteDocumentSchemeConstructorReceive, TAuthRequestStandardModel<int>, ResponseBaseModel>()
            ...
            .RegisterMqListener<FormFieldDirectoryDeleteConstructorReceive, TAuthRequestStandardModel<int>, ResponseBaseModel>()
            ...
            .RegisterMqListener<FormFieldDeleteConstructorReceive, TAuthRequestStandardModel<int>, ResponseBaseModel>()
            ...
            .RegisterMqListener<FormDeleteConstructorReceive, TAuthRequestStandardModel<int>, ResponseBaseModel>()
            ...
            .RegisterMqListener<GetElementsOfDirectoryConstructorReceive, int, TResponseModel<List<EntryModel>?>>()
            ...
            .RegisterMqListener<DeleteElementFromDirectoryConstructorReceive, TAuthRequestStandardModel<int>, ResponseBaseModel>()
            ...
            .RegisterMqListener<DeleteDirectoryConstructorReceive, TAuthRequestStandardModel<int>, ResponseBaseModel>()
            ...
            .RegisterMqListener<GetDirectoriesConstructorReceive, ProjectFindModel, TResponseModel<EntryModel[]>>()
            ...
            .RegisterMqListener<GetMembersOfProjectConstructorReceive, int, TResponseModel<EntryAltModel[]>>()
