...
public static class RegisterMqListenerExtension
{
    ...
    public static IServiceCollection BankRegisterMqListeners(this IServiceCollection services)
    {
        return services
            ...
            .RegisterMqListener<BankTransferCreateOrUpdateReceive, TAuthRequestStandardModel<BankTransferModelDB>, TResponseModel<int>>()
            ...
            .RegisterMqListener<InitPaymentMerchantTBankReceive, TAuthRequestStandardModel<InitMerchantTBankRequestModel>, TResponseModel<PaymentInitTBankResultModelDB>>()
