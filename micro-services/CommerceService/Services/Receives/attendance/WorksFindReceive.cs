...
/// WorksFindReceive
/// </summary>
public class WorksFindReceive(ICommerceService commerceRepo)
    : IResponseReceive<WorkFindRequestModel?, WorksFindResponseModel?>
{
    /// <inheritdoc/>
    ...
    public async Task<WorksFindResponseModel?> ResponseHandleActionAsync(WorkFindRequestModel? req, CancellationToken token = default)
    {
        ...
        return await commerceRepo.WorksSchedulesFindAsync(req, token: token);
    }
}