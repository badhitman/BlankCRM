...
public static class RegisterMqListenerExtension
{
    ...
    public static IServiceCollection IdentityRegisterMqListeners(this IServiceCollection services)
    {
        return services
            ...
            .RegisterMqListener<CreateUserManualReceive, TAuthRequestStandardModel<UserInfoBaseModel>, TResponseModel<string>>()
            ...
            .RegisterMqListener<GetUsersIdentityByTelegramReceive, long[], TResponseModel<UserInfoModel[]>>()
            .RegisterMqListener<TelegramAccountRemoveIdentityJoinReceive, TAuthRequestStandardModel<TelegramAccountRemoveJoinRequestIdentityModel>, ResponseBaseModel>()
            .RegisterMqListener<TelegramJoinAccountCreateReceive, string, TResponseModel<TelegramJoinAccountModelDb>>()
            .RegisterMqListener<FindUsersTelegramReceive, SimplePaginationRequestStandardModel, TPaginationResponseStandardModel<TelegramUserViewModel>>()
            ...
            .RegisterMqListener<SetRoleForUserReceive, TAuthRequestStandardModel<SetRoleForUserRequestModel>, TResponseModel<string[]>>()
            .RegisterMqListener<SelectUsersOfIdentityReceive, TPaginationRequestStandardModel<SimpleBaseRequestModel>, TPaginationResponseStandardModel<UserInfoModel>>()
            ;
    }
}