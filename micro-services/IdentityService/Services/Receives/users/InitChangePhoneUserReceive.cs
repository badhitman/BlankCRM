...
public class InitChangePhoneUserReceive(IIdentityTools idRepo, ILogger<InitChangePhoneUserReceive> loggerRepo)
    : IResponseReceive<TAuthRequestModel<string>?, ResponseBaseModel?>
{
    /// <inheritdoc/>
    ...
    /// </summary>
    public async Task<ResponseBaseModel?> ResponseHandleActionAsync(TAuthRequestModel<string>? req, CancellationToken token = default)
    {
