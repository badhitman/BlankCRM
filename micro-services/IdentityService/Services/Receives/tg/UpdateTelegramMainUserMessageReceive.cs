...
/// </summary>
public class UpdateTelegramMainUserMessageReceive(IIdentityTools identityRepo, ILogger<UpdateTelegramMainUserMessageReceive> _logger)
    : IResponseReceive<MainUserMessageModel?, ResponseBaseModel?>
{
    ...
    /// <inheritdoc/>
    public async Task<ResponseBaseModel?> ResponseHandleActionAsync(MainUserMessageModel? req, CancellationToken token = default)
    {
        ...
        return await identityRepo.UpdateTelegramMainUserMessageAsync(req, token);
    }
}