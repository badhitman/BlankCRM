...
namespace DbPostgreLib.Migrations
{
    ...
    [Migration("20260204070055_MainAppContext011")]
    partial class MainAppContext011
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SharedLib.AttachesMessageWebChatModelDB", b =>
                {
                    b.HasOne("SharedLib.MessageWebChatModelDB", "MessageOwner")
                        .WithOne("AttachesFiles")
                        .HasForeignKey("SharedLib.AttachesMessageWebChatModelDB", "MessageOwnerId")
