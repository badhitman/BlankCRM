...
namespace DbPostgreLib.Migrations.Realtime
{
    ...
    [Migration("20260327052346_RealtimeContext002")]
    partial class RealtimeContext002
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SharedLib.DialogWebChatModelDB", b =>
                {
                    ...
                    b.Property<string>("FirebaseCloudMessagingToken")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("FirebaseCloudMessagingToken");
            ...
            modelBuilder.Entity("SharedLib.MessageWebChatModelDB", b =>
                {
                    ...
                    b.Property<bool>("InitiatorMessageSender")
                        .HasColumnType("boolean");
