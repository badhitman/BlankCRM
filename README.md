...
### [Tools (maui app)](https://github.com/badhitman/BlankCRM/tree/main/ToolsMauiApp)
![api local client](ToolsMauiApp/img/tools-sync-folders.png)
Windows/Android утилита для удалённого взаимодействия с сервисами. Работает через штатный [rest/api](https://github.com/badhitman/BlankCRM/tree/main/ApiRestService):
...
- Загрузка файлов КЛАДР 4.0. Утилита позволяет [загружать/обновлять](https://github.com/badhitman/BlankCRM/tree/main/ToolsMauiApp#%D0%BA%D0%BB%D0%B0%D0%B4%D1%80-40) реестр адресов от ГНИВЦ/ФНС
