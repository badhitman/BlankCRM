...
В процессе загрузки данные делятся на порции и записываются в предварительное хранилище (**StorageService**). По окончанию успешной загрузки всех данных - данные из предварительного хранилища (**StorageService**) в место постоянного использования (**KladrService**)