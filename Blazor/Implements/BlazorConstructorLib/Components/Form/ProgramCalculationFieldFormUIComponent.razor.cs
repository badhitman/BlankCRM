...
namespace BlazorConstructorLib.Components.Form;
...
public partial class ProgramCalculationFieldFormUIComponent : ComponentBase
{
    ...
    readonly IEnumerable<CommandEntryModel> Entries = ExtensionsBlazorLib.CommandsAsEntries<VirtualColumnCalculationAbstraction>();
