...
builder.Services
          ...
          .RegisterEventNotify<StateWebChatModel>()
...
builder.Services
    ...
    .AddScoped<IConstructorTransmission, ConstructorTransmissionRabbit>()
    ...
    .AddScoped<IDaichiBusinessApiTransmission, DaichiBusinessTransmissionRabbit>()
    .AddScoped<IRusklimatComApiTransmission, RusklimatComTransmissionRabbit>()
    .AddScoped<IFeedsHaierProffRuService, HaierProffRuTransmissionRabbit>()
    .AddScoped<IBreezRuApiTransmission, BreezRuTransmissionRabbit>()
