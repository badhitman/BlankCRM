...
public partial class IssueCardPage : BlazorBusyComponentBaseAuthModel
{
    ...
    bool CanEdit =>
        ...
        CurrentUserSession?.Roles?.Contains(GlobalStaticConstantsRoles.Roles.HelpDeskManager) == true ||
    ...
    async Task FindOrders()
    {
        ...
        TResponseModel<OrderDocumentModelDB[]> res = await CommRepo.OrdersByIssuesGetAsync(req);
