/srv/dumps.sh
systemctl stop web.app.service comm.app.service tg.app.service api.app.service bus.app.service filesindexing.app.service constructor.app.service hd.app.service identity.app.service kladr.app.service ldap.app.service
...
cp -r /srv/git/builds/FilesIndexingService /srv/services/FilesIndexing
...
systemctl start comm.app.service web.app.service bus.app.service filesindexing.app.service tg.app.service api.app.service hd.app.service constructor.app.service identity.app.service kladr.app.service ldap.app.service